...
function Footer() {
  return (
    <div className="w-full h-auto bg-[black]/50 backdrop-blur-md  text-gray-200 shadow-lg shadow-[balck]/90 p-[15px] 630:p-0 ">
      <div className=" w-full 1000:w-[1000px] h-auto 630:h-[300px] flex flex-col items-center  justify-center m-auto  ">
        <div className="w-full h-full flex flex-row items-center justify-around flex-wrap">
          ...
          <div className="min-w-[200px]  h-auto flex flex-col  items-center 630:items-start justify-start">
            ...
            <a
              href="https://discord.com/users/691797362452201503"
              className=" flex flex-row items-center my-[15px] hover:underline cursor-pointer "
              target="blank"
            >
              <svg
            ...
            <a
              href="https://www.linkedin.com/in/muhammad-daffa-205835247"
              className=" flex flex-row items-center my-[15px] hover:underline cursor-pointer "
              target="blank"
            >
              <svg
