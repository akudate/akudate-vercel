...
export const Project: Project_data[] = [
  ...
  },
  {
    ...
    design_blog:
      "",
    dependencies_blog:
      "You can use manual download or Composer to install the dependencies. In this case I'm using Composer",
    package: [
  ...
  },
  {
    ...
    package: [
      "create-project laravel/laravel dispora-app",
    ...
    conclusion_blog: "",
    youtube_link: "http://diasporacirebonkab.online",
    githhub_link: "https://github.com/JagatCorp/Dispora_Cirebon",
    frontend_dowload_link:
      "",
    backend_dowload_link:
      "",
  ...
  },
  {
    ...
    say_xi: "Introduction",
    say_xi_blog:
      "A Sushi themed website made with Vite",
    technology_feature: [
      "HTML",
      "CSS",
      "JavaScript",
    ...
    about_this_app:
      "A fully responsive Sushi themed website using only HTML, CSS, and a little bit of JS. Intended to help beginners learn how to made a fully responsive website.",
    design_blog:
      "",
    dependencies_blog:
